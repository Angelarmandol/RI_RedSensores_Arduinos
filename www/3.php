...
<head>
	...
	<link href="css/common.css?ts=1574411486" rel="stylesheet" type="text/css" />
	<link href="css/3.css?ts=1574411486" rel="stylesheet" type="text/css" />
	<ga-code/>
...
<div class="wb_cont_inner"><div id="wb_element_instance36" class="wb_element wb-menu"><ul class="hmenu"><li><a href="" target="_self">Home</a></li><li><a href="About-us/" target="_self">About us</a></li><li><a href="Services/" target="_self">Services</a></li><li class="active"><a href="Contacts/" target="_self">Contacts</a></li></ul><div class="clearfix"></div></div><div id="wb_element_instance37" class="wb_element wb_text_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle"><a href="">R</a>ed de Sensores</h4></div><div id="wb_element_instance38" class="wb_element wb_element_picture" title=""><a href=""><img alt="gallery/3facc3c5f0b2baa7e654a7fead3d3483" src="gallery_gen/6c76c7bef4e73b871fa4323999da1d70_69x67.png"></a></div></div><div class="wb_cont_outer"></div><div class="wb_cont_bg"></div></div>
<div class="vbox wb_container" id="wb_main">
	
<div class="wb_cont_inner"><div id="wb_element_instance40" class="wb_element wb_text_element" style=" line-height: normal;"><p class="wb-stl-normal"><span style="font-size: 16px; font-weight: normal; line-height: 26px; background-color: transparent;">You will find the latest information about us on this page. Our company is constantly evolving and growing. We provide wide range of services. Our...</span></p>
<p class="wb-stl-normal">Mission is to provide best solution that helps everyone. If you want to contact us, please fill the contact form on our website. We wish you a good day! You will find the latest information about us on this page. Our company is...</p></div><div id="wb_element_instance41" class="wb_element"><form class="wb_form" method="post" enctype="multipart/form-data"><input type="hidden" name="wb_form_id" value="a9e12055"><textarea name="message" rows="3" cols="20" class="hpc"></textarea><table><tr><th class="wb-stl-normal">Name&nbsp;&nbsp;</th><td><input type="hidden" name="wb_input_0" value="Name"><input class="form-control form-field" type="text" value="" name="wb_input_0" required="required"></td></tr><tr><th class="wb-stl-normal">E-mail&nbsp;&nbsp;</th><td><input type="hidden" name="wb_input_1" value="E-mail"><input class="form-control form-field" type="text" value="" name="wb_input_1" required="required"></td></tr><tr class="area-row"><th class="wb-stl-normal">Message&nbsp;&nbsp;</th><td><input type="hidden" name="wb_input_2" value="Message"><textarea class="form-control form-field form-area-field" rows="3" cols="20" name="wb_input_2" required="required"></textarea></td></tr><tr class="form-footer"><td colspan="2"><button type="submit" class="btn btn-default">Submit</button></td></tr></table></form><script type="text/javascript">
			<?php $wb_form_id = popSessionOrGlobalVar("wb_form_id"); if ($wb_form_id == "a9e12055") { ?>
				...
				<?php } ?>
			<?php } ?>
			</script></div><div id="wb_element_instance42" class="wb_element wb_text_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle" style="text-align: center;"><span class="wb-stl-highlight"><span class="wb_tr_ok"><span class="wb_tr_ok"><span class="wb_tr_ok"><span class="wb_tr_ok"><span class="wb_tr_ok"><span class="wb_tr_ok">Contacts</span></span></span></span></span></span></span></h4></div><div id="wb_element_instance45" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance45");
...
<div class="wb_cont_inner" style="height: 146px;"><div id="wb_element_instance39" class="wb_element wb_text_element" style=" line-height: normal;"><p class="wb-stl-footer">© 2019 <a href="http://reddesensores2019.000webhostapp.com">reddesensores2019.000webhostapp.com</a></p></div><div id="wb_element_instance46" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
